...
- Bonus round: implement bonus spin chain, bonus timer, bonus-specific grants, and max-chain behavior.
- Rewards and jars management: real CRUD screens beyond placeholders while preserving append-only history.
- Integrity loop: daily check-in UI, streak display, warnings, and clock-tamper messaging.
